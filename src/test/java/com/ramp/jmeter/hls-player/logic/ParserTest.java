 ...
 */
		...
		String result = p.selectMediaPlaylist(res, "280x180", "170129", "customBandwidth", "customResolution");
		...
		result = p.selectMediaPlaylist(res, "640x360", "1395723", "customBandwidth", "customResolution");
		...
		result = p.selectMediaPlaylist(res, "320x180", "", "minBandwidth", "customResolution");
		...
		result = p.selectMediaPlaylist(res, "640x480", "", "maxBandwidth", "customResolution");
		...
		result = p.selectMediaPlaylist(res, "640x480", "1395723", "customBandwidth", "customResolution");
		expected = "/videos/DianaLaufenberg_2010X/video/680k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
		...
		result = p.selectMediaPlaylist(res, "640x360", "", "minBandwidth", "customResolution");
		expected = "/videos/DianaLaufenberg_2010X/video/600k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
		...
		result = p.selectMediaPlaylist(res, "640x360", "", "maxBandwidth", "customResolution");
		expected = "/videos/DianaLaufenberg_2010X/video/600k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
		...
		result = p.selectMediaPlaylist(res, "", "1395723", "customBandwidth", "maxResolution");
		expected = "/videos/DianaLaufenberg_2010X/video/680k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
		...
		result = p.selectMediaPlaylist(res, "", "", "minBandwidth", "maxResolution");
		expected = "/videos/DianaLaufenberg_2010X/video/680k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
		...
		result = p.selectMediaPlaylist(res, "", "", "maxBandwidth", "maxResolution");
		expected = "/videos/DianaLaufenberg_2010X/video/680k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
		...
		result = p.selectMediaPlaylist(res, "", "1395723", "customBandwidth", "minResolution");
		expected = "/videos/DianaLaufenberg_2010X/video/600k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
		...
		result = p.selectMediaPlaylist(res, "", "", "minBandwidth", "minResolution");
		...
		result = p.selectMediaPlaylist(res, "", "", "maxBandwidth", "minResolution");
		expected = "/videos/DianaLaufenberg_2010X/video/600k.m3u8?preroll=Thousands&uniqueId=4df94b1d";
