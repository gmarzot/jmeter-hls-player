...
public class ParserTest {
    ...
    public void testGetBaseUrl() throws Exception {
        ...
        RequestInfo requestInfoResult = p.getBaseUrl(urlMock, sampleResultMock, true);

        RequestInfo requestInfoExpected = new RequestInfo();

        requestInfoExpected.setRequestHeaders("GET  http://www.mock.com\n");
        requestInfoExpected.setHeaders(headers);
        requestInfoExpected.setResponse(payload);
        requestInfoExpected.setResponseCode("200");
        requestInfoExpected.setResponseMessage("OK");
        requestInfoExpected.setContentType("application/json;charset=UTF-8");
        requestInfoExpected.setSuccess(true);
        requestInfoExpected.setSentBytes(payload.length());
        requestInfoExpected.setContentEncoding("UTF-8");

        assertEquals(requestInfoExpected, requestInfoResult);
