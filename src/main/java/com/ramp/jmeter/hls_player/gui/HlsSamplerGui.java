...
public class HlsSamplerGui extends AbstractSamplerGui {
    ...
    public void configure(TestElement el) {
        ...
        hlsSamplerPanel.setCustomAudio(sampler.getCustomAudio());
        hlsSamplerPanel.setCustomCC(sampler.getCustomCC());
    ...
    public void modifyTestElement(TestElement s) {
        ...
        if (s instanceof HlsSampler) {
            ...
            sampler.setCustomAudio(hlsSamplerPanel.getCustomAuido());
            sampler.setCustomCC(hlsSamplerPanel.getCustomCC());
    ...
    public void clearGui() {
        ...
        this.hlsSamplerPanel.setCustomAudio("");
        this.hlsSamplerPanel.setCustomCC("");
    }
